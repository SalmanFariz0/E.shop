var productList = [
    ...
    let productsShowCase = document.querySelector(".products-show-case");
    let clothSection = document.createElement("div");
    clothSection.id = "clothes-section";
    let clothSectionH1 = document.createElement("h1");
    clothSectionH1.innerText="Clothing For Men And Women"
    clothSectionH1.className='card-heading';
    let cardWrapperCloth = document.createElement("div");
    cardWrapperCloth.className='card-wrapper';

    let accessoriesSection = document.createElement("div");
    accessoriesSection.id="accessories-section";
    let accessorySectionH1 = document.createElement("h1");
    accessorySectionH1.innerText="Accessories For Men And Women"
    accessorySectionH1.className='card-heading';
    let cardWrapperAccessory = document.createElement("div");
    cardWrapperAccessory.className='card-wrapper';

    clothSection.append(clothSectionH1,cardWrapperCloth);
    accessoriesSection.append(accessorySectionH1,cardWrapperAccessory);
    productsShowCase.append(clothSection,accessoriesSection);
    ...
    for(var i=0;i<productList.length;i++){
      ...
      productImg.src= productList[i].preview;
     ...
     /* appending */
     productCard.append(productImg,productDetails);
     productDetails.append(productName,productBrand,productPrice);
     if(productList[i].isAccessory == false){
       cardWrapperCloth.appendChild(productCard);
     }else{
       cardWrapperAccessory.appendChild(productCard);
     }
